...
if ex_ip != '183.100.232.2444':
    ...
    def txt_check(file_name,text):
        if text.count("동서가구"):
            pyautogui.screenshot(f'C://Users//Data2//OneDrive//바탕 화면//property//sinsagae//{file_name}_text.jpg')
                ...
                if check == '동서가구':
                    ...
                    while count < len(lists):
                        try:
                            ...
                            pyautogui.screenshot(f'C://Users//Data2//OneDrive//바탕 화면//property//sinsagae//{file_name}_img.jpg')
                            print('스크린샷 완료')
                            print(f'C://Users//Data2//OneDrive//바탕 화면//property//sinsagae//{file_name}_img.jpg')
